Feature: Soap Note Creation from Schedule flow
  ...
  Scenario Outline: Verify Creating Schedule Appointment Using Soap Notes
    ...
    * I click on edit soapnotes
    ...
    #* I click on add Medication plus button
    #* I enter <MedicationCode> as the medication code
    ...
    * I enter <LabResults> as lab results in search and select analyte
